    ...
    <SiteLayout>
        ...
        <div className="px-4 xs:px-10 lg:px-20 w-full max-w-[1365px] mx-auto flex flex-col gap-14">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl font-medium motion-preset-slide-down motion-delay-100 motion-duration-1000">
              Hey, I'm Cristian{" "}
              <span className="motion-preset-wobble motion-loop-twice motion-duration-500/rotate motion-delay-1000 inline-block">
                👋
              </span>
            </h2>
            <p className="max-w-[590px] pt-6 motion-delay-500 motion-preset-slide-up motion-preset-fade motion-duration-1500">
              I’m mostly <i>Typescript-adjacent</i> with a professional toolkit
              involving
              <span>Java, React, Node, and PostgreSQL</span>. On the side, I’ve
              been messing around with C and Go while hunting down the best
              matcha in <span>San Diego, CA</span>. I’m big on clean
              abstractions, strong typing, and finding tech that just
              <i>feels right</i>.
            </p>
          </div>
      ...
      >
        <h2
          ...
          className="hidden text-3xl sm:text-4xl font-medium"
        >
          Programming
        </h2>
        ...
        <section className="flex flex-col gap-8">
          <h3 className="text-2xl sm:text-3xl font-medium">More Projects</h3>
